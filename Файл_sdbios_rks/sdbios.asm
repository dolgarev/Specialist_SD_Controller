...
; (c) 22-05-2013 vinxru
     ...
     .org 08F00h-766 ; Последний байт кода должен быть 08EFFh
...
Error:     
     ...
     ; Очистка экрана, переменные BIOS могут быть испорчены
     CALL	BiosInit
...
CmdExec:
     ...
     ; Инициализация переменных BIOS и очистка экрана
     CALL	BiosInit
...
;----------------------------------------------------------------------------
; Инициализация переменные BIOS и очистка экрана
